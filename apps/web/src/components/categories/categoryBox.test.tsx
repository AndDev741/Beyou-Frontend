 ...
 */
test("draws the week beside the level once there is history", () => {
    ...
    // And the week's total next to the level, which is the metadata half of the ask.
 ...
 */
test("shows the level bar alone when the category has no history", () => {
