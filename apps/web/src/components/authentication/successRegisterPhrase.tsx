...
function SuccessRegisterPhrase(){
    ...
    return(
        <div className={`${successRegister === true ? "flex items-center justify-center absolute w-[100vw] lg:w-[450px] h-[110px] lg:h-[100px] lg:rounded-control border-2 border-solid border-success bg-surface top-0 lg:top-10 lg:left-[100px]" 
        : "hidden"}`}>
