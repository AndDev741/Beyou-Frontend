...
function Button({text, size, mode, onClick, type, icon, testId, disabled}: buttonProps){
    ...
    switch(mode){
        case "cancel":
            style = "rounded-[20px] text-lg lg:text-2xl font-semibold bg-secondary/10 text-secondary hover:bg-secondary/20 hover:shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 border border-border";
            break;
        case "create":
            ...
            break;
        case "default":
            style = "bg-background rounded-control text-secondary text-lg lg:text-2xl font-semibold hover:bg-primary/90 hover:shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 border border-description"
            break;
    }
