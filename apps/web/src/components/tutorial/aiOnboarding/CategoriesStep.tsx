                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    active
                                        ...
                                        : "bg-secondary/5 text-secondary border-primary/15 hover:border-primary/40 hover:-translate-y-0.5"
                                )}
                            >
                                {chip.iconId && (
                                    <BeyouIcon
            ...
            <div className="w-full max-w-md space-y-4">
                <div className="flex items-stretch gap-2">
                    <input
                        ...
                        className="flex-1 rounded-xl border border-primary/20 bg-background px-4 py-2.5 text-secondary placeholder:text-description focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-colors"
                    />
                    <button
                        type="button"
                        onClick={addCustom}
                        aria-label={t("AiOnboardingAdd")}
                        className="flex items-center gap-1.5 rounded-xl bg-secondary/10 px-4 py-2.5 font-semibold text-secondary hover:bg-secondary/20 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                    >
                ...
                <button
                    ...
                    className={cn(
                        ...
                        canContinue
                            ? "bg-primary hover:bg-primary/90 hover:-translate-y-0.5 shadow-lg shadow-primary/25"
