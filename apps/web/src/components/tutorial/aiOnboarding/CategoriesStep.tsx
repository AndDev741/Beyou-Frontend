    ...
    return (
        <div className="flex flex-col items-center gap-8 md:gap-10 w-full max-w-4xl mx-auto text-center">
            <div className="space-y-3">
                ...
                <p className="text-text-2 text-base md:text-lg max-w-xl mx-auto">
            ...
            <div className="w-full max-w-md space-y-4">
                <div className="flex items-stretch gap-2">
                    ...
                    <button
                        ...
                        className="flex shrink-0 items-center gap-1.5 rounded-card px-4 py-2.5 font-semibold text-text hover:brightness-95 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                    >
