...
function IconsBox({
    ...
    const borderCss =
        "border border-border rounded-control w-[45vw] md:w-[320px] lg:w-[15rem] bg-background";
        ...
        <div className="flex flex-col">
            <div className="flex">
                ...
                <input
                    ...
                    name="icon"
                    id="icon"
                    className="w-[30vw] md:w-[190px] ml-1 pl-1 border border-border rounded-control outline-none bg-background text-secondary placeholder:text-placeholder transition-colors duration-200"
                        ...
                        <button
                            ...
                            className={`${
                                entry.id === selectedCanonical
                                    ? "scale-110 text-primary border-2 border-accent rounded-control"
                                    : "text-description"
