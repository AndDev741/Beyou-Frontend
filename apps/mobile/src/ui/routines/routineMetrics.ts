/**
 * Cópia literal de `apps/web/src/components/routines/routineMetrics.ts`. É
 * lógica pura sobre os tipos compartilhados; vive nos dois apps até alguém
 * mover para um pacote. Se mudar aqui, mude lá.
 */
